...
\begin{frame}
	...
	\begin{columns}
		...
		\includegraphics[height=\textheight,keepaspectratio]{../../PRAATJES/badfit}
		\end{column}
		\begin{column}{0.5\textwidth}
		\includegraphics[height=\textheight,keepaspectratio]{../../PRAATJES/gamcheckok}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\includegraphics[height=.8\textheight,keepaspectratio]{../../PRAATJES/acf}\\
